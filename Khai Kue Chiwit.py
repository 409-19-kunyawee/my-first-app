...
menu_prices = {
    "เครปไข่เจียว ราคา 35 บาท": 35,
    "ซุปไข่ข้นมะเขือเทศ ราคา 40 บาท": 40,
    "ไข่ตุ๋นเนื้อหมูเด้ง ราคา 40 บาท": 40,
    "ไข่ลูกเขยระเบิด ราคา 40 บาท": 39,
}
...
if total_price < min_amount_for_discount:
    ...
    # เงื่อนไขเมื่อถึงยอดขั้นต่ำ (เช่น ลด 20%)
